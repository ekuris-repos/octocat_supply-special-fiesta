            ...
            >
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M3 3h2l.4 2m0 0L7 15h10l2-8H6.4m-1 0L5 5m2 14a1 1 0 100 2 1 1 0 000-2zm10 0a1 1 0 100 2 1 1 0 000-2z"
                />
              </svg>
              {itemCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-primary text-white text-xs font-semibold min-w-5 h-5 rounded-full flex items-center justify-center px-1">
                  {itemCount}
                </span>
              )}
            </Link>
